...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"2"}'>
      <el-form-item :style='{"margin":"0 10px"}'>
        ...
        <el-select v-model="formSearch.sushehao" placeholder="请选择宿舍号" :clearable="true">
          <el-option v-for="(item, index) in sushehaoOptions" :key="index" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>检查日期</div>
        <el-date-picker 
          v-model="timeRange"
          type="daterange"
          ...
          range-separator="至"
          start-placeholder="检查日期起始"
          end-placeholder="检查日期结束"
...
<script>
  export default {
    ...
    created() {
      ...
      this.$http.get('option/qinshixinxi/sushehao').then(res => {
        if (res.data.code == 0) {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.timeRange.length > 0) {
          searchWhere.jianchariqistart = this.timeRange[0];
          searchWhere.jianchariqiend = this.timeRange[1];
        }
